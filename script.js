const products = [
    { id: 1, title: "ادناء ازرار كامل", price: "200 شيكل", desc: "ادناء شرعي بخامة ممتازة، مريح جداً وعصري، متوفر مع بنطال عريض او تنورة.", sizes: ["S", "M", "L"], soldOutSizes: [], images: ["image/تفاصيل ادناء ازرار.jpg", "image/ادناء ازرار اخضر غامق.jpg", "image/ادناء ازرار كامل اخضر.jpg", "image/ادناء ازرار كامل خمري.jpg", "image/ادناء ازرار لون بيج.jpg", "image/ادناء ازرار نهدي غامق.jpg"] },
    { id: 2, title: "ادناء سحاب مخفي", price: "200 شيكل", desc: "ادناء شرعي بخامة ممتازة، مريح جداً وعصري، متوفر مع بنطال عريض او تنورة.", sizes: ["S", "M", "L"], soldOutSizes: [], images: ["image/تفاصيل ادناء سحاب.jpg", "image/ادناء سحاب كامل زهري.jpg", "image/ادناء سحاب مخفي اخضر بارد.jpg", "image/ادناء سحاب نهدي.jpg"] },
    ...
    { id: 5, title: "فستان عباية خصر", price: "200 شيكل", desc: "عباءة قطعتين مح حركة جميلة عند الخصر", sizes: ["38", "40", "42", "44", "46", "48"], soldOutSizes: [], images: ["image/فستان عباية اخضر.jpeg", "image/فستان عباية اسود.jpeg", "image/فستان عباية نهدي.jpeg"] },
    ...
    { id: 12, title: "معطف شتوي ملون", price: "250 شيكل", desc: "معطف شتوي بتصاميم وألوان عصرية تناسب ذوقك.", sizes: ["38", "40", "42", "44", "46", "48"], soldOutSizes: [], images: ["image/معطف ابيض.jpeg", "image/معطف اخضر.jpeg", "image/معطف بيج.jpeg"] },
